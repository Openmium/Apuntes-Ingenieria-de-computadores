...
#
# Script generated by Vivado on Mon Apr 13 21:45:39 +0200 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : conversor.sh
...
#
# Usage        : conversor.sh
#                conversor.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                conversor.sh [-rerun]
#                conversor.sh [-reset_run]
#                conversor.sh [-clean]
#                conversor.sh [-reset_log]
#                conversor.sh [-help]
#
...
# script info
echo -e "conversor.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./conversor.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip --snapshot conversor xil_defaultlib.conversor -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim conversor -key {Behavioral:sim_1:Functional:conversor} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb conversor.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./conversor.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: conversor.sh [-help]\n\
Usage: conversor.sh [-step]\n\
Usage: conversor.sh [-lib_map_path]\n\
Usage: conversor.sh [-rerun]\n\
Usage: conversor.sh [-reset_run]\n\
Usage: conversor.sh [-clean]\n\
Usage: conversor.sh [-reset_log]\n\
Usage: conversor.sh [-keep_index]\n\
Usage: conversor.sh [-noclean_files]\n\n\
