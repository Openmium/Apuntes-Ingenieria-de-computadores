...
HD_PWD='C:/Users/pablo/Documents/Vivado Projects/Practica6_1/Practica6_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log S7_Segmt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source S7_Segmt.tcl
