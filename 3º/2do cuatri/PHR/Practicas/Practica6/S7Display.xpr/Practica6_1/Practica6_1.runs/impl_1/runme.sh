...
HD_PWD='C:/Users/pablo/Documents/Vivado Projects/Practica6_1/Practica6_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log S7_Segmt.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source S7_Segmt.tcl -notrace
