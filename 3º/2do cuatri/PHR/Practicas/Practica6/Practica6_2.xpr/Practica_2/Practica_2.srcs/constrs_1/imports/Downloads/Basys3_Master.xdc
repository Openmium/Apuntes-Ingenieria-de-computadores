...
## Clock signal
set_property PACKAGE_PIN W5 [get_ports clockInput]
set_property IOSTANDARD LVCMOS33 [get_ports clockInput]
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports clockInput]
...
#set_property PACKAGE_PIN W2 [get_ports input]
...
#set_property PACKAGE_PIN P3 [get_ports output]
...
#set_property IOSTANDARD LVCMOS33 [get_ports SSEG_AN0]
#set_property PACKAGE_PIN U4 [get_ports SSEG_AN1]
#set_property IOSTANDARD LVCMOS33 [get_ports SSEG_AN1]
#set_property PACKAGE_PIN V4 [get_ports SSEG_AN2]
#set_property IOSTANDARD LVCMOS33 [get_ports SSEG_AN2]
#set_property PACKAGE_PIN W4 [get_ports SSEG_AN3]
#set_property IOSTANDARD LVCMOS33 [get_ports SSEG_AN3]
