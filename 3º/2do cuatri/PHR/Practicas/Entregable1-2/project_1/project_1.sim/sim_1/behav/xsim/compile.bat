...
REM
REM Generated by Vivado on Mon Mar 23 12:40:05 +0100 2026
...
echo "xvhdl --incr --relax -prj test_PAL_realimentacion_vhdl.prj"
call xvhdl  --incr --relax -prj test_PAL_realimentacion_vhdl.prj -log xvhdl.log
