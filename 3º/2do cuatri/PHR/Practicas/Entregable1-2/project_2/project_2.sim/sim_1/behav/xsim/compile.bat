...
REM
REM Generated by Vivado on Mon Mar 23 22:09:15 +0100 2026
...
echo "xvhdl --incr --relax -prj test_comparador_gel_4bit_vhdl.prj"
call xvhdl  --incr --relax -prj test_comparador_gel_4bit_vhdl.prj -log xvhdl.log
