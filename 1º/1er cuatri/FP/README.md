...
Todos hemos pasado por aquí y hemos sufrido, que no te engañen esto es una asignatura de 9 créditos dividida en dos partes (quizá para aumentar la tasa de aprobados).  
...
Algunos programas están incompletos o a medio hacer, pero **las prácticas de taller de programación (TP) deberían estar enteras y ser mínimamente útiles**.
